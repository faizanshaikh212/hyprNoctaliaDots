...
-- Default springs
hl.curve("easy", { type = "spring", mass = 1, stiffness = 450, dampening = 45 })

-- Speed Increase (i.e. lower the speed = +)
...
hl.animation({ leaf = "layersIn", enabled = true, speed = 1.8, bezier = "easeOutQuint", style = "fade" })
